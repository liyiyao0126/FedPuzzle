...
from client.causal_discovery.datasets import InterventionalDataset
...
class GraphFitting(object):
    ...
    def gradient_estimator(self, adj_matrices, log_likelihoods, gamma, theta, var_idx):
        ...
        theta_grads_clone = theta_grads.clone() #这两行改了
        theta_grads -= theta_grads_clone.transpose(0, 1)  # theta_ij = -theta_ji
