...
from Enco.causal_discovery.distribution_fitting import DistributionFitting
from Enco.causal_discovery.utils import track, find_best_acyclic_graph
from Enco.causal_discovery.multivariable_mlp import create_model
from Enco.causal_discovery.multivariable_flow import create_continuous_model
from Enco.causal_discovery.graph_fitting import GraphFitting
from Enco.causal_discovery.datasets import ObservationalCategoricalData
from Enco.causal_discovery.optimizers import AdamTheta, AdamGamma
...
class ENCO(object):
    ...
    def __init__(self,
        ...
        print("enco num_vars:",self.num_vars)
    ...
    def get_binary_adjmatrix(self):
        ...
        """
        binary_gamma = torch.sigmoid(self.gamma) > self.gamma_threshold
        binary_theta = torch.sigmoid(self.theta) > self.theta_threshold
